            ...
            <div class="form-row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <div v-if="submitForm && $v.formModel.password.$error" class="invalid-feedback">
                            <span v-if="!$v.formModel.password.required">User Password is required</span>
                            <span v-if="!$v.formModel.password.minLength">Password Minimum Length 8</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="form-group" v-if="selectedUserType == 'employee'">
            <div class="form-row">
                <div class="col-md-6">
                    ...
                    />
                    <!-- <div v-if="submitForm && $v.formModel.company_name.$error" class="invalid-feedback">
                        <span v-if="!$v.formModel.company_name.required">Company Name is Required.</span>
                    </div> -->
                </div>
                <div class="col-md-6">
        ...
        <div class="form-group" v-if="selectedUserType == 'customer' || selectedUserType == 'employee'">
            <div class="form-row">
                <div class="col-md-6">
                    ...
                    />
                    <!-- <div v-if="submitForm && $v.formModel.email_optional.$error" class="invalid-feedback">
                        <span v-if="!$v.formModel.email_optional.email">Must be valid Email</span>
                    </div> -->
                </div>
                <div class="col-md-6">
                    ...
                    />
                    <!-- <div v-if="submitForm && $v.formModel.phone_optional.$error" class="invalid-feedback">
                        <span v-if="!$v.formModel.phone_optional.numeric">Provide Valid Phone Number.</span>
                        <span v-if="!$v.formModel.phone_optional.minLength">Phone Number not Less than 11.</span>
                        <span v-if="!$v.formModel.phone_optional.maxLength">Phone Number not Greater than 11.</span>
                    </div> -->
                </div>
            </div>
        </div>
            ...
            <div class="form-row">
                <div class="col-md-12">
                    ...
                    <!-- <div v-if="submitForm && $v.formModel.address.$error" class="invalid-feedback">
                        <span v-if="!$v.formModel.address.required">User Address is Required</span>
                    </div> -->
                </div>
            </div>
        </div>
