        ...
        <div class="container-fluid">
            <ul class="list-unstyled topnav-menu float-right mb-0">
                ...
                <b-nav-item-dropdown variant="white" class="d-none d-lg-inline-block" right toggle-class="header-item">
                    ...
                    <b-dropdown-item 
                        class="notify-item" 
                        v-for="(entry, i) in languages" :key="`Lang${i}`"
                        :value="entry" 
                            ...
                            <div class="row">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.uicontent.list.widgets') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.uicontent.list.nestable') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.uicontent.list.rangeslider') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.uicontent.list.masonry') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.uicontent.list.treeview') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.uicontent.list.tour') }}
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.application.list.crm') }}</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.application.list.template') }}
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.extrapages.list.leftsidebaruser') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.extrapages.list.collapsed') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.extrapages.list.leftsidebar') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.extrapages.list.header') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.extrapages.list.search') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.extrapages.list.gallery') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                {{ $t('navbar.dropdown.megamenu.extrapages.list.maintenance') }}
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="text-center mt-3">
                                ...
                                <button class="btn btn-primary btn-rounded mt-3">
                                    {{ $t('navbar.dropdown.megamenu.buttontext') }}
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        data() {
            return {
                languages: [{
                    ...
                    {
                        flag: require("~/assets/images/flags/bangla.jpg"),
                        language: "bn",
                        title: "বাংলা",
                    },
                ],
